...
export default function Landing() {
  ...
  return (
    <section
     className="flex flex-col justify-center items-center space-y-6 h-full min-h-screen w-screen bg-wallpaper text-neutral-200"
     id="home"
    >
      <img
      ...
      <hgroup className="flex flex-col items-center space-y-2 tracking-widest">
        <h1 className="text-5xl font-medium">ŁUKASZ ŚLIWIŃSKI</h1>
